    ...
    <view class="wrapper">
      ...
      <view class="input-content">
        <view class="input-item" v-if="event == 'register'">
          ...
          <input type="text" :value="username" placeholder="请输入用户名" data-key="username" @input="inputChange" />
        </view>
        <view class="input-item">
          <text class="tit">手机号码</text>
          <input type="number" :value="mobile" placeholder="请输入手机号码" data-key="mobile" @input="inputChange" />
        </view>
        <view class="input-item">
        ...
        <view class="input-item">
          ...
          <input type="text" :value="captcha" placeholder="请输入验证码" data-key="captcha" @input="inputChange" />
...
export default {
  ...
  methods: {
    ...
    async toLogin() {
      ...
      if (data) {
        this.$store.dispatch('userLogin', data.userinfo)
        setTimeout(function () {
          uni.navigateBack()
        }, 3000)
      } else {
